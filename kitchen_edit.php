...
$tracking_page_name="kitchen_edit.php";
...
$content = 'Edit kitchen_device';       //variable for edit user, named £content
if (isset($_POST['submit'])) {      //update database grupp17_users, collect data from database, fname,lname and email, where id, collect id from database
 $query = <<<END
UPDATE kitchen_devices
SET kitchen_name = '{$_POST['kitchen_name']}'
WHERE id = '{$_GET['id']}'
END;
...
END;
 ...
 $content = <<<END
<form method="post" action="kitchen_edit.php?id={$row->id}" style="padding-left:40%;"> 
	<p> Please enter your new device name! </p>
 <input type="text" name="kitchen_name" required placeholder ="Device name"><br>
