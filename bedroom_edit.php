...
$tracking_page_name="bedroom_edit.php";
...
$content = 'Edit bedroom_device';       //variable for edit user, named £content
...
SET bedroom_name = '{$_POST['bedroom_name']}'
WHERE id = '{$_GET['id']}'
END;
...
END;
 ...
 $content = <<<END
<form method="post" action="bedroom_edit.php?id={$row->id}" style="padding-left:40%;"> 
	<p> Please enter your new device name! </p>
 <input type="text" name="bedroom_name" required placeholder ="Device name"><br>
