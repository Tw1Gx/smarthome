...
$content = 'Edit bathroom_device';       //variable for edit user, named £content
...
SET bathroom_name = '{$_POST['bathroom_name']}'
WHERE id = '{$_GET['id']}'
END;
...
END;
 ...
 $content = <<<END
<form method="post" action="bathroom_edit.php?id={$row->id}" style="padding-left:40%;"> 
	<p> Please enter your new device name! </p>
 <input type="text" name="bathroom_name" required placeholder ="Device name"><br>
