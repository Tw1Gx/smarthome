...
$content = 'Edit hallway_device';       //variable for edit user, named £content
...
SET hallway_name = '{$_POST['hallway_name']}'
WHERE id = '{$_GET['id']}'
END;
...
END;
 ...
 $content = <<<END
<form method="post" action="hallway_edit.php?id={$row->id}" style="padding-left:40%;"> 
	<p> Please enter your new device name! </p>
 <input type="text" name="hallway_name" required placeholder ="Device name"><br>
